...
execute rotated ~ 0 run function aj_ramiel_mode_1:summon_model/__generated__/execute/0
execute as @e[type=armor_stand,tag=aj.ramiel_mode_1.root_entity,tag=new] run function aj_ramiel_mode_1:summon_model/__generated__/execute/1
tag @s remove new