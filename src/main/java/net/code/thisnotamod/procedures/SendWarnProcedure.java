	...
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments) {
		...
		if (mc != null && mc.level != null && mc.player != null) {
			...
			try {
				...
				text = MessageArgument.getMessage(arguments, "warn_text");
			} catch (Exception e) {
				text = Component.literal("Ошибка чтения ввода.");
			}
			CustomTipOverlay.queueTip(text, new ItemStack(ThisnotamodModItems.WARNINGICON.get()), new ResourceLocation("thisnotamod", "notif_warning"));
		}
	}
}
