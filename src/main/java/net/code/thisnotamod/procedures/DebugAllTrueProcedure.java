...
public class DebugAllTrueProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		ThisnotamodModVariables.MapVariables.get(world).worldDebug = true;
		ThisnotamodModVariables.MapVariables.get(world).syncData(world);
		Minecraft mc = Minecraft.getInstance();
		if (mc != null && mc.level != null && mc.player != null) {
			CustomTipOverlay.queueTip(Component.literal("Включена отладка всех частей мода."), new ItemStack(ThisnotamodModItems.INFOICON.get()), new ResourceLocation("thisnotamod", "hint"));
		}
	}
}
