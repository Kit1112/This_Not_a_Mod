...
public class RepairAllServersProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (mc != null && mc.level != null && mc.player != null) {
			CustomTipOverlay.queueTip(Component.literal(("Отремонтировано " + ThisnotamodModVariables.MapVariables.get(world).datamap1.size() + " \u0441\u0435\u0440\u0432\u0435\u0440\u043E\u0432.")), new ItemStack(ThisnotamodModItems.INFOICON.get()),
