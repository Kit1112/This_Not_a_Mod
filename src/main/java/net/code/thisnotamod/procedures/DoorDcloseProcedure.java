...
public class DoorDcloseProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if ((world.getBlockState(BlockPos.containing(x - 1, y + 1, z))).getBlock() == ThisnotamodModBlocks.VOTV_DOOR_TOP.get()
				&& ((world.getBlockState(BlockPos.containing(x - 1, y + 1, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip3
						? (world.getBlockState(BlockPos.containing(x - 1, y + 1, z))).getValue(_getip3)
						: -1) == 3) {
			{
			...
			if ((new Object() {
				...
				PlayAnimDoorCloseDownProcedure.execute(world, x, y, z, blockstate);
			}
		} else if ((world.getBlockState(BlockPos.containing(x + 1, y + 1, z))).getBlock() == ThisnotamodModBlocks.VOTV_DOOR_TOP.get()
				&& ((world.getBlockState(BlockPos.containing(x + 1, y + 1, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip24
						? (world.getBlockState(BlockPos.containing(x + 1, y + 1, z))).getValue(_getip24)
						: -1) == 3) {
			if ((new Object() {
				public Direction getDirection(BlockState _bs) {
					Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
				...
				&& ((world.getBlockState(BlockPos.containing(x, y + 1, z + 1))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip44
						? (world.getBlockState(BlockPos.containing(x, y + 1, z + 1))).getValue(_getip44)
						: -1) == 3) {
			if ((new Object() {
				public Direction getDirection(BlockState _bs) {
					Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
				...
				&& ((world.getBlockState(BlockPos.containing(x, y + 1, z - 1))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip64
						? (world.getBlockState(BlockPos.containing(x, y + 1, z - 1))).getValue(_getip64)
						: -1) == 3) {
			if ((new Object() {
				public Direction getDirection(BlockState _bs) {
					Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
