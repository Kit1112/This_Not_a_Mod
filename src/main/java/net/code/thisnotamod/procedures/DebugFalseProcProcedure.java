...
public class DebugFalseProcProcedure {
	public static void execute(Entity entity) {
		...
		if (mc != null && mc.level != null && mc.player != null) {
			CustomTipOverlay.queueTip(Component.literal("Выключена отладка клиентских частей мода."), new ItemStack(ThisnotamodModItems.INFOICON.get()), new ResourceLocation("thisnotamod", "hint"));
		}
	}
}
