...
public class Lvl1Procedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof DriveItem)
			(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().putString("geckoAnim", "lvl1");
    ...
    if (stack.getItem() instanceof net.code.thisnotamod.item.DriveItem drive) {
        drive.triggerAnim(sp, id, "main", "lvl1");
    }
}
