...
public class SwitchRBMProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity) {
		...
		if ((blockstate.getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip1 ? blockstate.getValue(_getip1) : -1) == 1) {
			...
			ThisnotamodMod.queueServerWork(1, () -> {
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("thisnotamod:button_switch")), SoundSource.BLOCKS, (float) 0.7, 1);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("thisnotamod:button_switch")), SoundSource.BLOCKS, (float) 0.7, 1, false);
					}
				}
				{
					int _value = 3;
			...
			ThisnotamodMod.queueServerWork(6, () -> {
				{
					int _value = 2;
					BlockPos _pos = BlockPos.containing(x, y, z);
					BlockState _bs = world.getBlockState(_pos);
			...
			LampSwitcherProcedure.execute(world, x, y, z, entity);
