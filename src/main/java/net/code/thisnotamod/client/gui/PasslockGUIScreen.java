...
import net.code.thisnotamod.network.PasslockGUIButtonMessage;
...
public class PasslockGUIScreen extends AbstractContainerScreen<PasslockGUIMenu> {
	private final static HashMap<String, Object> guistate = PasslockGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private final static HashMap<String, String> textstate = new HashMap<>();
	public static EditBox password_field;
	...
	public PasslockGUIScreen(PasslockGUIMenu container, Inventory inventory, Component text) {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		password_field.render(guiGraphics, mouseX, mouseY, partialTicks);
	...
	public boolean keyPressed(int key, int b, int c) {
		...
		if (password_field.isFocused())
			return password_field.keyPressed(key, b, c);
	...
	public void resize(Minecraft minecraft, int width, int height) {
		String password_fieldValue = password_field.getValue();
		super.resize(minecraft, width, height);
		password_field.setValue(password_fieldValue);
	}
	...
	public void init() {
		super.init();
		password_field = new EditBox(this.font, this.leftPos + 8, this.topPos + 24, 118, 18, Component.translatable("gui.thisnotamod.passlock_gui.password_field"));
		password_field.setMaxLength(32767);
		guistate.put("text:password_field", password_field);
		this.addWidget(this.password_field);
		imagebutton_pas_b_1 = new ImageButton(this.leftPos + 6, this.topPos + 63, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_1.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(0, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_2 = new ImageButton(this.leftPos + 47, this.topPos + 63, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_2.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(1, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_3 = new ImageButton(this.leftPos + 88, this.topPos + 63, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_3.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(2, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 2, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_4 = new ImageButton(this.leftPos + 6, this.topPos + 84, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_4.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(3, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 3, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_5 = new ImageButton(this.leftPos + 47, this.topPos + 84, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_5.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(4, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 4, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_6 = new ImageButton(this.leftPos + 88, this.topPos + 84, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_6.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(5, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 5, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_7 = new ImageButton(this.leftPos + 6, this.topPos + 105, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_7.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(6, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 6, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_8 = new ImageButton(this.leftPos + 47, this.topPos + 105, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_8.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(7, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 7, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_9 = new ImageButton(this.leftPos + 88, this.topPos + 105, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_9.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(8, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 8, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_deny = new ImageButton(this.leftPos + 6, this.topPos + 126, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_deny.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(9, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 9, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_0 = new ImageButton(this.leftPos + 47, this.topPos + 126, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_0.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(10, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 10, x, y, z, textstate);
			}
		});
		...
		imagebutton_pas_b_access = new ImageButton(this.leftPos + 88, this.topPos + 126, 40, 20, 0, 0, 20, new ResourceLocation("thisnotamod:textures/screens/atlas/imagebutton_pas_b_access.png"), 40, 40, e -> {
			if (true) {
				textstate.put("textin:password_field", password_field.getValue());
				ThisnotamodMod.PACKET_HANDLER.sendToServer(new PasslockGUIButtonMessage(11, x, y, z, textstate));
				PasslockGUIButtonMessage.handleButtonAction(entity, 11, x, y, z, textstate);
			}
		});
