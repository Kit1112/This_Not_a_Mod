...
import net.code.thisnotamod.init.ThisnotamodModTabs;
import net.code.thisnotamod.init.ThisnotamodModSounds;
import net.code.thisnotamod.init.ThisnotamodModPaintings;
...
@Mod("thisnotamod")
public class ThisnotamodMod {
	public static final Logger LOGGER = LogManager.getLogger(ThisnotamodMod.class);
	public static final String MODID = "thisnotamod";
	...
	public ThisnotamodMod() {
		...
		ThisnotamodModSounds.REGISTRY.register(bus);
		ThisnotamodModBlocks.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									ThisnotamodMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			ThisnotamodMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
