...
public class VentCornerHorizontalTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public VentCornerHorizontalTileEntity(BlockPos pos, BlockState state) {
		super(ThisnotamodModBlockEntities.VENT_CORNER_HORIZONTAL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(VentCornerHorizontalBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<VentCornerHorizontalTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<VentCornerHorizontalTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("vent_corner_horizontal");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Угол вентиляции (горизонтальный)");
	}
