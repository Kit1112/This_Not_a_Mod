...
public class WorkStatTest2TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WorkStatTest2TileEntity(BlockPos pos, BlockState state) {
		super(ThisnotamodModBlockEntities.WORK_STAT_TEST_2.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(WorkStatTest2Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WorkStatTest2TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WorkStatTest2TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("work_stat_test_2");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Work Stat Test 2");
	}
