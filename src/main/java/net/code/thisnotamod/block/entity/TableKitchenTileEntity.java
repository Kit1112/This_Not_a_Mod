...
public class TableKitchenTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TableKitchenTileEntity(BlockPos pos, BlockState state) {
		super(ThisnotamodModBlockEntities.TABLE_KITCHEN.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(TableKitchenBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TableKitchenTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TableKitchenTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("table_kitchen");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Кухонный стол");
	}
