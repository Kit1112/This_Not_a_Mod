...
public class RadiotielieskopTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RadiotielieskopTileEntity(BlockPos pos, BlockState state) {
		super(ThisnotamodModBlockEntities.RADIOTIELIESKOP.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(RadiotielieskopBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RadiotielieskopTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RadiotielieskopTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("radiotielieskop");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Радиотелескоп (нажми ПКМ по нижнему блоку)");
	}
