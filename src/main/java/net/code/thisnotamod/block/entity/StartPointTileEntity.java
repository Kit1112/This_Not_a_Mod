...
public class StartPointTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public StartPointTileEntity(BlockPos pos, BlockState state) {
		super(ThisnotamodModBlockEntities.START_POINT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(StartPointBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<StartPointTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<StartPointTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("start_point");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Стартовая точка для дрона");
	}
