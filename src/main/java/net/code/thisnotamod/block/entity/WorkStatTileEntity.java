...
public class WorkStatTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WorkStatTileEntity(BlockPos pos, BlockState state) {
		super(ThisnotamodModBlockEntities.WORK_STAT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(WorkStatBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WorkStatTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WorkStatTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("work_stat");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Work Stat");
	}
