...
package net.code.thisnotamod.world.dimension;
...
public class VotvQuestingDimension {
	@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
	public static class VotvQuestingSpecialEffectsHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("thisnotamod:votv_questing"), customEffect);
		}
	}
}
