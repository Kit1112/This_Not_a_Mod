...
public class FridgeDownIntMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FridgeDownIntMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ThisnotamodModMenus.FRIDGE_DOWN_INT.get(), id);
