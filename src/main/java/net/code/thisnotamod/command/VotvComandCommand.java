...
public class VotvComandCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(
				Commands.literal("votv").requires(s -> s.hasPermission(4)).then(Commands.literal("modifier").then(Commands.literal("scanner_speed").then(Commands.argument("speed", DoubleArgumentType.doubleArg(0.1, 2)).executes(arguments -> {
