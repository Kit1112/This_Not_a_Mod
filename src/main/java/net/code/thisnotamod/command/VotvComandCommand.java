	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("votv").requires(s -> s.hasPermission(4)).then(Commands.literal("AllowDebug").then(Commands.literal("true").executes(arguments -> {
			...
			return 0;
				...
				Commands.literal("send").then(Commands.literal("hint").then(Commands.literal("info").then(Commands.argument("player_info", EntityArgument.player()).then(Commands.argument("info_text", MessageArgument.message()).executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
					...
					return 0;
				})))).then(Commands.literal("warn").then(Commands.argument("player_warn", EntityArgument.player()).then(Commands.argument("warn_text", MessageArgument.message()).executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
					...
					return 0;
				})))).then(Commands.literal("error").then(Commands.argument("player_error", EntityArgument.player()).then(Commands.argument("error_text", MessageArgument.message()).executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
